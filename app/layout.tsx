      ...
      <body className="min-h-screen bg-background font-sans antialiased">
        ...
        >
          <div className="flex min-h-screen flex-col">
            <header className="border-b border-border bg-card/95 text-card-foreground backdrop-blur supports-[backdrop-filter]:bg-card/80 shadow-elevation-sm sticky top-0 z-40">
            ...
            <footer className="border-t border-border bg-background text-muted-foreground text-xs text-center py-6">
              <div className="container mx-auto flex h-4 items-center justify-between px-4">
                <p>
  Hospital Management System &mdash;{' '}
  <a
