...
export async function GET() {
  ...
  // The admissions/rooms RLS policies are self-referential and exceed the
  // PostgreSQL stack depth for authenticated sessions (SQLSTATE 54001).
  // Access is already gated to Admin above, so read through the service
  // client (see utils/supabase/service.ts usage policy).
