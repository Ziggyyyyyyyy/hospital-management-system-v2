      ...
      <Card className="lg:col-span-1 relative">
        ...
        <CardContent className="grid gap-4 text-sm">
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-2">
              <BadgeDollarSign className="mt-0.5 h-4 w-4 shrink-0 text-muted-foreground" aria-hidden />
              <span>
                <span className="block text-xs text-muted-foreground">National ID</span>
            ...
            <div className="flex items-start gap-2">
              <Droplet className="mt-0.5 h-4 w-4 shrink-0 text-muted-foreground" aria-hidden />
              <span>
                <span className="block text-xs text-muted-foreground">Blood Type</span>
                <span className="font-medium text-foreground">
                  {patientProfile?.blood_type || 'N/A'}
                </span>
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3 border-t pt-4">
            <div className="flex items-start gap-2">
              ...
              <span>
                ...
                <span className="font-medium tabular-nums text-foreground">
                  {displayedPhoneNumber || user?.phone_number || 'N/A'}
                </span>
              </span>
            </div>
            <div className="flex items-start gap-2">
              ...
              <span>
                ...
                <span className="font-medium text-foreground">{user?.address || 'N/A'}</span>
              </span>
            </div>
          </div>
          ...
          <div className="border-t pt-4">
            <div className="flex items-start gap-2">
              <Contact className="mt-0.5 h-4 w-4 shrink-0 text-muted-foreground" aria-hidden />
              <span>
                <span className="block text-xs text-muted-foreground">Emergency Contact ID</span>
                <span className="font-medium tabular-nums text-foreground">
